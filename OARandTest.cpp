...
bool testInsert(cop3530::OAMap<signed int, char, 0>& map){
...
bool testRemove(cop3530::OAMap<signed int, char, 0>& map){
	int index = rand() % MAX_SIZE;
...
bool testSearch(cop3530::OAMap<signed int, char, 0>& map){
	int index = rand() % MAX_SIZE;
...
int main(){
	...
	cin >> mapSize;
	cop3530::OAMap<signed int, char, 0> map(mapSize);
