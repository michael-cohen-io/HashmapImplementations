...
bool testInsert(cop3530::RBST<double, char>& map){
...
bool testRemove(cop3530::RBST<double, char>& map){
	int index = rand() % MAX_SIZE;
...
bool testSearch(cop3530::RBST<double, char>& map){
	int index = rand() % MAX_SIZE;
...
int main(){
	...
	cin >> mapSize;
	cop3530::RBST<double, char> map(mapSize);
