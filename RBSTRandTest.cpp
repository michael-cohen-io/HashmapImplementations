...
bool testInsert(cop3530::RBST<signed int, char>& map){
...
bool testRemove(cop3530::RBST<signed int, char>& map){
	int index = rand() % MAX_SIZE;
...
bool testSearch(cop3530::RBST<signed int, char>& map){
	int index = rand() % MAX_SIZE;
...
int main(){
	...
	cin >> mapSize;
	cop3530::RBST<signed int, char> map(mapSize);
